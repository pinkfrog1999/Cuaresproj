                                        ...
                                        <table width="100%">
                                            ...
                                            ?>
                                                ...
                                                <tr class="border-t-b">
                                                    ...
                                                    <td> </td>
                                                    <td class="pb-10"><a href="<?php echo base_url(); ?>users/changeStatus?id=<?php echo $reservation->id; ?>" style="font-size: 14px;"><button class="bg-primary btn-xs" type="button" onclick="return confirm('Claim Order?')" style="display: <?php echo $reservation->status; ?>"><i class="fa fa-calendar-check-o"></i>&nbsp;Claim</button></a></td>
                                                </tr>
                                             <?php   
                                                }
                                            ?>
